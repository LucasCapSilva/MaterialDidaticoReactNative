...
export default class Home extends Component {
  static navigationOptions = ({ navigation }) => ({
    ...
    headerTitle: (<Image source={require('../../../assets/generation.png')} style={{ width: 130, height: 30 }} />),
    headerLeft: (
      <TouchableOpacity size={30} onPress={() => navigation.navigate('FindAllCategoria')} style={{ width: '100%', height: 77, alignItems: 'center', justifyContent: 'center' }}>
        <FontAwesome name="arrow-left" size={30} style={{ paddingLeft: 20 }} />
      </TouchableOpacity>
    ),
    headerRight: (
